...
def pdf(nome,estado_civil,profissao,cpf,rg,rua,bairro,municipio,estado,cep,fone,nomePro,estado_civilPro,profissaoPro,cpfPro,rgPro,ruaPro,municipioPro,bairroPro,estadoPro,cepPro,fonePro,texto):
